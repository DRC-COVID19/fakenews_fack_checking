const loadNews = (data, parentNode) => {
  ...
  for (let news of data) {
    ...
    const title =
      typeof news.title != "undefined" ? `data-title=${news.title}` : "";
    const image =
